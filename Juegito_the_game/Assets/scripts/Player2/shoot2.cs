    ...
    void Update()
    {
        ...
        if (timer > cadency && Input.GetAxis(playerNumber+"RT") == 0 && shotCharge != 0)
        {
            if (DirectionJoyL == new Vector2(0, 0))
                DirectionJoyL = new Vector2(GameObject.Find("Player2").GetComponent<Movement2>().side, 0); // multiplicat that for 1 or -1 depending on were are you facing!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        {
            if (DirectionJoyL == new Vector2(0, 0))
                DirectionJoyL = new Vector2(GameObject.Find("Player2").GetComponent<Movement2>().side, 0);
